      ...
      <v-fade-transition hide-on-leave>
        <div v-if="predictStep == 2">
          ...
          <div v-if="features['Position'] == 'ML Engineer'">
            <div class="questionTitle fBold" style="text-align: center">
              <span class="textBlue">Data Scientist! Loved it.</span> please
              pick your most relevan technology.
            </div>
            <div class="d-flex justify-center">
              <div
          ...
          <div v-if="features['Position'] == 'DevOps'">
            <div class="questionTitle fBold" style="text-align: center">
              ...
              your most relevan infrastructure platform.
            </div>
            <div class="d-flex justify-center">
              <div
                class="d-flex justify-center align-center"
          ...
          <div v-if="features['Position'] == 'Mobile Developer'">
            <div class="questionTitle fBold" style="text-align: center">
              ...
              pick your most relevan infrastructure platform.
            </div>
            <div class="d-flex justify-center">
              <div
                class="d-flex justify-center align-center"
            ...
            <div class="d-flex justify-center">
              ...
              >
                ...
                <v-btn
                  ...
                  dark
                  @click="
                    nextStep('Yearly brutto salary in EUR', expectedSalary)
                  "
                  >OK!</v-btn
                >
              </div>
        ...
        <div v-if="predictStep == 11">
          ...
          <div v-else>
            <div>
              <div class="questionTitle fBold" style="text-align: center">
                <span class="textBlue"
                  >Sorry, this feature is under construction. Try predicting the
                  <a @click="$router.push('/predict/salary')"> salary</a>
                  instead.
                </span>
              </div>
  ...
  methods: {
    retrieveTokenData() {
      ...
      var config = {
        method: "post",
        url:
          "https://gw.jp-tok.apigw.appdomain.cloud/api/4635e8924e0681012c39e6a33b37e10b413cf33e443cb4bbf5ab3325ebe4c10d/iam-proxy",
        headers: {
    ...
    startPredicting() {
      ...
      axios({
        url:
          "https://gw.jp-tok.apigw.appdomain.cloud/api/4635e8924e0681012c39e6a33b37e10b413cf33e443cb4bbf5ab3325ebe4c10d/proxy-of-watson-auto-ai?version=2021-04-29",
        method: "POST",
        headers: {
